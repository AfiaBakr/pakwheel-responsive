    ...
    return(
        <div className="bg-slate-100">
            <div className="text-center">
                <h1 className="text-sm md:text-5xl py-8 "><b><u>Hundai Elantra 2024 Price in Pakistan, Images, Reviews & <br/>Specs.</u></b></h1>
            </div>
            <div>
            ...
            <div className=" mr-16 h-12 w-20 md:h-auto md:w-auto">
                <img className="ring-2 ring-slate-800 mb-1/2 rounded-tr-xl" src="./hundai/hundai2.jpg"
                alt="Hundai Elantra"
                width={150}
                height={100}/>
                ...
                <img className="ring-2 ring-slate-800 mt-1/2 rounded-br-xl" src="./hundai/hundai4.jpg"
                alt="Hundai Elantra"
                width={150}
                height={100}/>
            </div>
            ...
            <div className="text-center mt-10 ">
                <h1 className="text-lg md:text-2xl text-green-600">PKR 97,00,00 lac</h1>
            </div>
            </div>
